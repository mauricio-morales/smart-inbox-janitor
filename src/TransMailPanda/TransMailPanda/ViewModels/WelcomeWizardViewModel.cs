...
namespace TransMailPanda.ViewModels;
...
public partial class WelcomeWizardViewModel : ViewModelBase
{
    ...
    public string WelcomeTitle => "Welcome to TransMail Panda";
    ...
    public string ReadyMessage => "TransMail Panda is ready to help you clean your inbox safely and efficiently.";
